  ...
  useEffect(()=>{
    ...
    useEffect(()=>{
        const loadResume:any=async()=>{
            ...
            const resumeUrl:string=URL.createObjectURL(pdfBlob);
  ...
  return (
    <main className='!pt-0'>
        <nav className="resume-nav">
            ...
            <span className='text-gray-500 text-sm font-semibold'>Back to Home Page</span>
            </Link>
        </nav>
        <div className="flex flex-row max-lg:flex-col-reverse">
            <section className="feedback-section bg-[url('/images/bg-small.svg') bg-cover h-[100vh] sticky top-0 items-center justify-center">
                {imageUrl && resumeUrl &&(
                    <div className="animation-in fade-in duration-1000 gradient-border max-sm:m-0 h-[90%] max-wxl:h-fit w-fit">
